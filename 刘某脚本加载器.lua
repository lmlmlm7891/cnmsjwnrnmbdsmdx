...
-- MainScript.lua
local NotificationManager = require(script.NotificationManager) -- 确保NotificationManager.lua在同一目录下

-- 创建通知管理器实例
local notificationManager = NotificationManager.new()

-- 显示一个成功通知
notificationManager:success("欢迎使用刘某脚本", "脚本加载中", 6)
...
-- 显示一个成功通知
notificationManager:success("刘某脚本", "脚本加载完成", 6)
