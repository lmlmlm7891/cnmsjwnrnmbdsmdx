...
-- 脚本开头动画 - 显示加载开始通知
notificationManager:success("刘某脚本", "脚本加载开始...", 3)
...
-- 脚本结尾部分 - 添加完成通知
local function showCompletionNotification()
    notificationManager:success("刘某脚本", "脚本运行完毕！", 6)
    notificationManager:info("刘某脚本", "感谢使用！", 4)
end
